        ...
        while(houveMelhoria){
            ...
            for(int i = 0; i < beam_width; i++){
                ...
                for(int j = 0; j < D.numeroItensUtilizados; j++){
                    ...
                    double suporte = (double)p.getTP()/(double)D.examplesNumber;
...
//            System.out.println("Cobertura +: " + Avaliador.coberturaPositivo(beam,k));
    ...
    public static void main(String[] args) throws FileNotFoundException{
       ...
       String caminhoBase = caminho + nomeBase;
        ...
        D.loadFile(caminhoBase, D.TIPO_CSV); //Loading database         
        D.setup("p");
...
//        filtrarAtributosValores[1][1] = "8";
        ...
        //Rodando SSDP
        long t0 = System.currentTimeMillis(); //Initial time
        double min_support = Math.sqrt(D.numeroExemplosPositivo)/D.examplesNumber; 
        ...
        System.out.println("### Base:" + D.baseName + "|D|=" + D.examplesNumber + ",|D+|=" + D.numeroExemplosPositivo +
                ",|D-|=" + D.numeroExemplosNegativo + ",|A|=" + D.attributesNumber + ",|I|=" + D.numeroItensUtilizados); //database name
