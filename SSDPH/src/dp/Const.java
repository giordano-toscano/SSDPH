...
//    public final static String CAMINHO_INDICE = Const.CAMINHO + "indice.txt";
    ...
    public final static String CAMINHO_BASES = "../datasets/";
    public final static String CAMINHO_BASES_EDITADAS = "../SSDPH/pastas/bases_editadas/";
    public final static String CAMINHO_RESULTADOS = "../SSDPH/pastas/resultados/";
    public final static String CAMINHO_RESULTADOS_OBJ = "../SSDPH/pastas/resultados_obj/";  
    public final static String CAMINHO_RELATORIO = "../SSDPH/pastas/relatorios/";
    public final static String CAMINHO_DICIONARIOS = "../SSDPH/pastas/dicionarios/";
    public final static String CAMINHO_INDICE = "../SSDPH/pastas/indice.txt";
